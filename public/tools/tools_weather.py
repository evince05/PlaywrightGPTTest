...
def tool_curr_weather_location(_controller: PlaywrightController, args: Dict[str, Any]) -> Dict[str, Any]:
	...
	try:
		...
		return _result_ok({"status": "retrieved", "location": location, "data": weather_info})
	except Exception as e:
		return _result_error(e)


def tool_future_weather_location(_controller: PlaywrightController, args: Dict[str, Any]) -> Dict[str, Any]:
	...
	try:
		...
		return _result_ok({"status": "retrieved", "location": location, "requested_date": date, "data": forecast_info})
	except Exception as e:
		return _result_error(e)
